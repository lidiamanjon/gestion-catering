...
function Print-LabelsDirect($job,$token,$printerName) {
  ...
  $handler = [System.Drawing.Printing.PrintPageEventHandler]{
    ...
    $small = New-Object System.Drawing.Font('Arial',6,[System.Drawing.FontStyle]::Bold,[System.Drawing.GraphicsUnit]::Point)
    $mid = New-Object System.Drawing.Font('Arial',9,[System.Drawing.FontStyle]::Bold,[System.Drawing.GraphicsUnit]::Point)
    $cadFont = New-Object System.Drawing.Font('Arial',22,[System.Drawing.FontStyle]::Bold,[System.Drawing.GraphicsUnit]::Point)
    $l = $labels[$script:LabelIndex]
    $titleFont = Fit-Font $g $l.producto 18 10 ([System.Drawing.FontStyle]::Bold) 56
    $g.DrawString('ALBARABA SL',$small,$gray,3,2)
    $g.DrawString($l.producto,$titleFont,$black,3,8)
    $g.DrawString(($l.destino).ToUpper(),$mid,$blue,3,23)
    if($l.lote){ $g.DrawString(('LOTE: ' + $l.lote),$mid,$black,3,32) }
    $g.DrawString(('CREADA: ' + $l.creada),$small,$gray,3,42)
    if($l.hecha){ $g.DrawString(('HECHA POR: ' + $l.hecha),$small,$gray,3,48) }
    $g.DrawString('CONSUMIR ANTES DE:',$small,$gray,3,58)
    $g.DrawString($l.cad,$cadFont,$red,3,65)
